package com.example.projfaturacartaospringbatch.reader;

import com.example.projfaturacartaospringbatch.model.CartaoCredito;
import com.example.projfaturacartaospringbatch.model.Cliente;
import com.example.projfaturacartaospringbatch.model.Transacao;
...
public class LerTransacoesReaderConfig {
    @Bean
    public JdbcCursorItemReader<Transacao> lerTransacoesReader(@Qualifier("appDS")DataSource dataSource){
